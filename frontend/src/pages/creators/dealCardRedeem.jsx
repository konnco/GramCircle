...
const DealCardRedeem = ({ deal, user, onClick, length }) => {
  ...
  return (
    <Card sx={{ maxWidth: 200, maxHeight: 300 }} className="relative z-0">
    ...
    opacity: '70%',
        ...
        <CardContent sx={{ maxWidth: 200, maxHeight: 100 }}>
          <Typography variant="body2" sx={{ fontWeight: '500', textAlign: 'center', fontFamily: "'Poppins', sans-serif", color: 'black' }}>
            {deal.campaign_data.campaignName}
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
